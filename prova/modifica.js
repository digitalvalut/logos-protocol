...
"notify.title":"Just send me a silent notice",
...
"listen.title":"Ring my phone","listen.sub":"The phone really rings, like a real call, for as long as you keep this screen open. Uses more battery; no outside service is involved.","listen.status":"Listening — if you switch screen or app, it stops until you come back here.",
...
"notify.title":"Mandami solo un avviso silenzioso",
...
"listen.title":"Fai squillare il telefono","listen.sub":"Il telefono squilla davvero, come una chiamata vera, finché tieni questa schermata aperta. Consuma più batteria; nessun servizio esterno è coinvolto.","listen.status":"In ascolto — se cambi schermata o app, si ferma finché non torni qui.",
...
"notify.title":"M'envoyer seulement un avis discret",
...
"listen.title":"Faire sonner mon téléphone","listen.sub":"Le téléphone sonne vraiment, comme un appel réel, tant que vous gardez cet écran ouvert. Consomme plus de batterie ; aucun service extérieur n'est impliqué.","listen.status":"À l'écoute — si vous changez d'écran ou d'appli, ça s'arrête jusqu'à votre retour ici.",
...
"notify.title":"Nur einen stillen Hinweis schicken",
...
"listen.title":"Mein Telefon klingeln lassen","listen.sub":"Das Telefon klingelt wirklich, wie bei einem echten Anruf, solange dieser Bildschirm geöffnet bleibt. Verbraucht mehr Akku; kein externer Dienst ist beteiligt.","listen.status":"In Bereitschaft — wechselst du Bildschirm oder App, stoppt es, bis du hierher zurückkehrst.",
...
"notify.title":"Enviarme solo un aviso silencioso",
...
"listen.title":"Hacer sonar mi teléfono","listen.sub":"El teléfono suena de verdad, como una llamada real, mientras mantengas esta pantalla abierta. Consume más batería; no interviene ningún servicio externo.","listen.status":"Escuchando — si cambias de pantalla o de app, se detiene hasta que vuelvas aquí.",
...
"notify.title":"Enviar-me apenas um aviso silencioso",
...
"listen.title":"Fazer tocar o meu telefone","listen.sub":"O telemóvel toca mesmo, como uma chamada real, enquanto mantiver este ecrã aberto. Consome mais bateria; nenhum serviço externo está envolvido.","listen.status":"À escuta — se mudar de ecrã ou de app, para até voltar aqui.",
...
"notify.title":"Присылать только беззвучное уведомление",
...
"listen.title":"Звонить на мой телефон","listen.sub":"Телефон звонит по-настоящему, как настоящий вызов, пока этот экран открыт. Расходует больше заряда; никакой внешний сервис не задействован.","listen.status":"На связи — если переключитесь на другой экран или приложение, приём остановится до возвращения сюда.",
...
"listen.title":"让我的手机响铃","listen.sub":"只要这个屏幕保持打开，手机就会像真正的电话一样响铃。会更耗电；不涉及任何外部服务。","listen.status":"正在等待来电——切换到其他屏幕或应用会暂停，回到这里才会恢复。",
...
"notify.title":"أرسل لي تنبيهًا صامتًا فقط",
...
"listen.title":"اجعل هاتفي يرن","listen.sub":"يرن الهاتف فعلًا كأنها مكالمة حقيقية، طالما أبقيت هذه الشاشة مفتوحة. يستهلك بطارية أكثر؛ لا يشارك أي خدمة خارجية.","listen.status":"بانتظار — إذا بدّلت الشاشة أو التطبيق، يتوقف حتى تعود إلى هنا.",
...
"home.bigStart":"تحدّث مع أحدهم","home.bigAddrD":"اكتبه هنا واتصل","home.bigBook":"جهات الاتصال","home.bigBookD":"الأشخاص الذين تحدثت معهم","home.joinLink":"دعوة لا تُفتح؟ الصق الرابط هنا","home.bigStartD":"أنشئ دعوة لإرسالها","set.lang":"اللغة","set.grpYou":"من أنت","set.grpFind":"كيف يجدونك","set.grpLook":"المظهر والاستخدام","set.grpAdv":"إعدادات متقدمة","set.textsize":"حجم النص","conn.direct":"اتصال مباشر بين الهاتفين","conn.directShort":"متصل مباشرة","conn.relay":"اتصال آمن عبر جسر مشفَّر","conn.relayShort":"متصل (جسر)","conn.down":"انقطع الاتصال","conn.downShort":"منقطع","conn.working":"جارٍ الاتصال","conn.wobbly":"تذبذب الاتصال — أحاول استعادته","conn.wobblyShort":"جارٍ الاستعادة","chat.linkLost":"انقطع الاتصال. لم يُفقد شيء.","chat.backHome":"العودة إلى الصفحة الرئيسية","chat.stillWobbly":"لم يعد الاتصال بعد. يمكنك الانتظار أكثر، أو العودة إلى الصفحة الرئيسية والمحاولة من جديد.",
...
"notify.title":"صرف خاموش اطلاع بھیجیں",
...
"listen.title":"میرا فون بجائیں","listen.sub":"جب تک آپ یہ اسکرین کھلی رکھیں، فون واقعی بجتا ہے، جیسے ایک اصل کال۔ زیادہ بیٹری استعمال ہوتی ہے؛ کوئی بیرونی سروس شامل نہیں۔","listen.status":"سن رہے ہیں — اگر آپ اسکرین یا ایپ بدلیں تو یہ رک جاتا ہے جب تک آپ یہاں واپس نہ آئیں۔",
...
"notify.title":"बस एक शांत सूचना भेजें",
...
"listen.title":"मेरा फ़ोन बजाएँ","listen.sub":"जब तक आप यह स्क्रीन खुली रखते हैं, फ़ोन सच में बजता है, असली कॉल की तरह। बैटरी ज़्यादा खर्च होती है; कोई बाहरी सेवा शामिल नहीं है।","listen.status":"सुन रहे हैं — अगर आप स्क्रीन या ऐप बदलते हैं, तो यह तब तक रुक जाता है जब तक आप यहाँ वापस नहीं आते।",
...
"notify.title":"শুধু একটি নীরব বিজ্ঞপ্তি পাঠান",
...
"listen.title":"আমার ফোন বাজান","listen.sub":"যতক্ষণ আপনি এই স্ক্রিন খোলা রাখবেন, ফোন সত্যিই বাজবে, আসল কলের মতো। বেশি ব্যাটারি খরচ হয়; কোনো বাইরের সেবা জড়িত নেই।","listen.status":"শুনছে — স্ক্রিন বা অ্যাপ পাল্টালে, আপনি এখানে ফিরে না আসা পর্যন্ত থেমে যাবে।",
...
"home.bigStart":"কারও সঙ্গে কথা বলুন","home.bigAddrD":"এখানে লিখুন আর কল করুন","home.bigBook":"পরিচিতি","home.bigBookD":"যাদের সাথে আপনি কথা বলেছেন","home.joinLink":"আমন্ত্রণ খুলছে না? লিঙ্কটি এখানে পেস্ট করুন","home.bigStartD":"পাঠানোর জন্য আমন্ত্রণ তৈরি করুন","set.lang":"ভাষা","set.grpYou":"আপনি কে","set.grpFind":"লোকে আপনাকে কীভাবে খুঁজে পায়","set.grpLook":"চেহারা ও ব্যবহার","set.grpAdv":"উন্নত সেটিংস","set.textsize":"লেখার আকার","conn.direct":"দুই ফোনের মধ্যে সরাসরি সংযোগ","conn.directShort":"সরাসরি যুক্ত","conn.relay":"এনক্রিপ্টেড সেতুর মাধ্যমে নিরাপদ সংযোগ","conn.relayShort":"যুক্ত (সেতু)","conn.down":"সংযোগ বিচ্ছিন্ন","conn.downShort":"বিচ্ছিন্ন","conn.working":"সংযোগ হচ্ছে","conn.wobbly":"সংযোগ টলে গেছে — আবার জুড়ছি","conn.wobblyShort":"আবার জুড়ছি","chat.linkLost":"সংযোগ বিচ্ছিন্ন হয়েছে। কিছুই হারায়নি।","chat.backHome":"হোমে ফিরে যান","chat.stillWobbly":"সংযোগ এখনও ফিরে আসেনি। আপনি আরও অপেক্ষা করতে পারেন, অথবা হোমে ফিরে গিয়ে আবার চেষ্টা করতে পারেন।",
...
"notify.title":"Kirim saja pemberitahuan senyap",
...
function renderContacts(){
  ...
  /* il numero sul pulsantone «Rubrica»: chi ha qualcuno lo vede subito */
  $('contactsCount').textContent = list.length ? String(list.length) : '';
  $('contactsCount').classList.toggle('hide', list.length === 0);
  refreshAddrDial();
...
/* ============================== how the app is doing ==============================
   ...
   guessing. */
const APP_VERSION = 'logos-modifica-4.45';
