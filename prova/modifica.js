...
async function mailboxPut(key, obj, tok){
  try{
    ...
    return e.riusciti > 0;
  }catch(e){ brokerReachable = false; brokerRefusing = false; return false; }
}
...
/* ============================== how the app is doing ==============================
   ...
   guessing. */
const APP_VERSION = 'logos-modifica-4.48';
