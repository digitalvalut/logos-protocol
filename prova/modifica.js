...
"easy.voiceTitle":"Say it out loud","secure.title":"Protected screen","secure.sub":"No screenshots, and a black preview in the app switcher. Off by default: on, you cannot screenshot the invite QR either.","easy.voiceSub":"The app tells you what to do in your own language. For anyone who finds the screen hard to read.","easy.voiceOn":"All right. From now on I'll tell you what to do out loud.","easy.sayHome":"At the top is your address: send it to whoever you like. Below, your contacts and the button to call an address.","easy.sayStart":"This is your code. Press the orange button to send it to whoever you like.","easy.sayJoin":"Type the six digits you were given.","easy.sayChat":"You're connected. You can talk now.",
...
"easy.voiceTitle":"Говорить вслух","secure.title":"Защищённый экран","secure.sub":"Никаких скриншотов, и чёрный предпросмотр в списке открытых приложений. По умолчанию выключено: если включить, скриншот QR‑кода приглашения тоже сделать нельзя.","easy.voiceSub":"Приложение вслух подсказывает, что делать, на вашем языке. Для тех, кому трудно читать с экрана.","easy.voiceOn":"Хорошо. Теперь я буду говорить вслух, что делать.","easy.sayHome":"Вверху ваш адрес: отправьте его кому хотите. Ниже — контакты и кнопка, чтобы позвонить по адресу.","easy.sayStart":"Это ваш код. Нажмите оранжевую кнопку, чтобы отправить его кому хотите.","easy.sayJoin":"Введите шесть цифр, которые вам дали.","easy.sayChat":"Вы соединены. Теперь можно говорить.",
...
"easy.voiceTitle":"读出来","secure.title":"屏幕保护","secure.sub":"禁止截屏，最近任务中显示为黑屏。默认关闭：开启后，邀请二维码也无法截屏。","easy.voiceSub":"应用会用你的语言把该做的事读出来。适合看屏幕吃力的人。","easy.voiceOn":"好的。从现在起我会把该做的事读给你听。","easy.sayHome":"顶部是你的地址：发给任何你想联系的人。下面是通讯录和呼叫地址的按钮。","easy.sayStart":"这是你的号码。按橙色按钮把它发给你想发的人。","easy.sayJoin":"输入别人给你的六位数字。","easy.sayChat":"已经连上了。现在可以说话了。",
...
"easy.voiceTitle":"بول کر بتاؤ","secure.title":"محفوظ اسکرین","secure.sub":"کوئی اسکرین شاٹ نہیں، اور کھلی ایپس میں سیاہ پیش نظارہ۔ بطورِ طے شدہ بند: آن کرنے پر دعوت کے QR کا اسکرین شاٹ بھی نہیں لیا جا سکتا۔","easy.voiceSub":"ایپ آپ کی زبان میں بول کر بتاتی ہے کہ کیا کرنا ہے۔ اُن کے لیے جنہیں اسکرین پڑھنا مشکل لگتا ہے۔","easy.voiceOn":"ٹھیک ہے۔ اب سے میں بول کر بتاؤں گا کہ کیا کرنا ہے۔","easy.sayHome":"اوپر آپ کا پتہ ہے: جسے چاہیں بھیجیں۔ نیچے رابطے اور کسی پتے پر کال کرنے کا بٹن ہے۔","easy.sayStart":"یہ آپ کا کوڈ ہے۔ جسے چاہیں بھیجنے کے لیے نارنجی بٹن دبائیں۔","easy.sayJoin":"جو چھ ہندسے آپ کو دیے گئے ہیں وہ لکھیں۔","easy.sayChat":"رابطہ ہو گیا۔ اب آپ بات کر سکتے ہیں۔",
...
"easy.voiceTitle":"बोलकर बताओ","secure.title":"सुरक्षित स्क्रीन","secure.sub":"कोई स्क्रीनशॉट नहीं, और खुले ऐप्स में काला पूर्वावलोकन। डिफ़ॉल्ट रूप से बंद: चालू करने पर आमंत्रण के QR का स्क्रीनशॉट भी नहीं ले सकते।","easy.voiceSub":"ऐप आपकी भाषा में बोलकर बताता है कि क्या करना है। उनके लिए जिन्हें स्क्रीन पढ़ना मुश्किल लगता है।","easy.voiceOn":"ठीक है। अब से मैं बोलकर बताऊंगा कि क्या करना है।","easy.sayHome":"ऊपर आपका पता है: इसे जिसे चाहें भेजें। नीचे संपर्क और किसी पते पर कॉल करने का बटन है।","easy.sayStart":"यह आपका कोड है। जिसे चाहें भेजने के लिए नारंगी बटन दबाएं।","easy.sayJoin":"आपको दिए गए छह अंक लिखें।","easy.sayChat":"जुड़ गए। अब आप बात कर सकते हैं।",
...
/* ============================== how the app is doing ==============================
   ...
   guessing. */
const APP_VERSION = 'logos-modifica-4.51';
