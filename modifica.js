...
"letter.title":"留给你的消息","letter.noneTitle":"现在没有人接听。","knock.note2":"改成给他写两行字","letter.directTitle":"两行字，不用打电话。","letter.directSub":"只有文字，最多 300 个字符：不能发照片和视频。对方一打开应用就能看到，七天内有效。","letter.noneSub":"我已经告诉对方你找过她了。如果你想多说几句，可以写在这里。","letter.ph":"在这里写下你的消息","letter.leave":"留下消息","letter.cancel":"算了","letter.needText":"写上一两句，让对方知道你想说什么。","letter.left":"消息已留下。对方打开应用就会看到。","letter.failed":"没能留下消息，请再试一次。","letter.callBack":"回拨","letter.dismiss":"完成",
...
"letter.title":"رسائل تُركت لك","letter.noneTitle":"لا أحد يردّ الآن.","knock.note2":"اكتب له سطرين بدلاً من ذلك","letter.directTitle":"سطران، بدون اتصال.","letter.directSub":"نص فقط، حتى 300 حرف: بدون صور أو فيديو. سيجدهما بمجرد فتح التطبيق، خلال سبعة أيام.","letter.noneSub":"أخبرتها بالفعل أنك حاولت الوصول إليها. إذا أردت أن تقول المزيد، اكتبه هنا.","letter.ph":"اكتب رسالتك هنا","letter.leave":"اترك الرسالة","letter.cancel":"لا بأس","letter.needText":"اكتب كلمتين ليعرف ماذا أردت.","letter.left":"تُركت الرسالة. سيجدها عند فتح التطبيق.","letter.failed":"لم أتمكن من ترك الرسالة. حاول مرة أخرى.","letter.callBack":"عاود الاتصال","letter.dismiss":"تم",
...
"letter.title":"আপনার জন্য রাখা বার্তা","letter.noneTitle":"এখন কেউ সাড়া দিচ্ছে না।","knock.note2":"বরং দুই লাইন লিখুন","letter.directTitle":"দুই লাইন, কল না করেই।","letter.directSub":"শুধু লেখা, সর্বোচ্চ ৩০০ অক্ষর: ছবি বা ভিডিও নয়। অ্যাপ খুললেই পেয়ে যাবেন, সাত দিনের মধ্যে।","letter.noneSub":"আমি তাকে আগেই জানিয়ে দিয়েছি যে আপনি তার সঙ্গে যোগাযোগের চেষ্টা করেছেন। আরও কিছু বলতে চাইলে এখানে লিখুন।","letter.ph":"আপনার বার্তা এখানে লিখুন","letter.leave":"বার্তা রাখুন","letter.cancel":"থাক","letter.needText":"দু-এক কথা লিখুন, যাতে বোঝেন আপনি কী চেয়েছিলেন।","letter.left":"বার্তা রাখা হয়েছে। অ্যাপ খুললেই দেখতে পাবেন।","letter.failed":"বার্তা রাখতে পারিনি। আবার চেষ্টা করুন।","letter.callBack":"ফিরে ডাকুন","letter.dismiss":"হয়েছে",
