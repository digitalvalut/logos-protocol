...
"home.bigStart":"Hablar con alguien","home.bigAddrD":"Escríbela aquí y llama","home.bigBook":"Contactos","home.bigBookD":"Las personas con las que has hablado","home.joinLink":"¿Una invitación que no se abre? Pega aquí el enlace","home.bigStartD":"Crea una invitación para enviar","set.lang":"Idioma","set.grpYou":"Quién eres","set.grpAdv":"Más","set.textsize":"Tamaño del texto","conn.direct":"Enlace directo entre los dos teléfonos","conn.directShort":"conectada directamente","conn.relay":"Enlace seguro, por un puente cifrado","conn.relayShort":"conectada (puente)","conn.down":"Conexión perdida","conn.downShort":"perdida","conn.working":"Conectando","conn.wobbly":"La conexión ha vacilado — la estoy recuperando","conn.wobblyShort":"recuperando","chat.linkLost":"La conexión se ha caído. No se ha perdido nada.","chat.backHome":"Volver al inicio","chat.stillWobbly":"La conexión todavía no ha vuelto. Puedes seguir esperando, o volver al inicio e intentarlo de nuevo.",
...
"home.bigStart":"Поговорить с кем-то","home.bigAddrD":"Введите его здесь и позвоните","home.bigBook":"Контакты","home.bigBookD":"Люди, с которыми вы говорили","home.joinLink":"Приглашение не открывается? Вставьте ссылку сюда","home.bigStartD":"Создать приглашение","set.lang":"Язык","set.grpYou":"Кто вы","set.grpAdv":"Ещё","set.textsize":"Размер текста","conn.direct":"Прямая связь между двумя телефонами","conn.directShort":"соединено напрямую","conn.relay":"Надёжная связь через зашифрованный мост","conn.relayShort":"соединено (мост)","conn.down":"Связь потеряна","conn.downShort":"потеряна","conn.working":"Соединение","conn.wobbly":"Связь дрогнула — восстанавливаю","conn.wobblyShort":"восстанавливаю","chat.linkLost":"Соединение прервалось. Ничего не потеряно.","chat.backHome":"Назад на главную","chat.stillWobbly":"Соединение пока не восстановилось. Можете подождать ещё, либо вернуться на главную и попробовать снова.",
...
"easy.voiceTitle":"读出来","secure.title":"屏幕保护","secure.sub":"禁止截屏，最近任务中显示为黑屏。默认关闭：开启后，邀请二维码也无法截屏。","easy.voiceSub":"应用会用你的语言把该做的事读出来。适合看屏幕吃力的人。","easy.voiceOn":"好的。从现在起我会把该做的事读给你听。","easy.sayHome":"点第一个按钮开始聊天。如果别人给你发了邀请，就点第二个。","easy.sayStart":"这是你的号码。按橙色按钮把它发给你想发的人。","easy.sayJoin":"输入别人给你的六位数字。","easy.sayChat":"已经连上了。现在可以说话了。",
...
"easy.voiceTitle":"बोलकर बताओ","secure.title":"सुरक्षित स्क्रीन","secure.sub":"कोई स्क्रीनशॉट नहीं, और खुले ऐप्स में काला पूर्वावलोकन। डिफ़ॉल्ट रूप से बंद: चालू करने पर आमंत्रण के QR का स्क्रीनशॉट भी नहीं ले सकते।","easy.voiceSub":"ऐप आपकी भाषा में बोलकर बताता है कि क्या करना है। उनके लिए जिन्हें स्क्रीन पढ़ना मुश्किल लगता है।","easy.voiceOn":"ठीक है। अब से मैं बोलकर बताऊंगा कि क्या करना है।","easy.sayHome":"बातचीत शुरू करने के लिए पहला बटन दबाएं। अगर किसी ने आपको निमंत्रण भेजा है तो दूसरा दबाएं।","easy.sayStart":"यह आपका कोड है। जिसे चाहें भेजने के लिए नारंगी बटन दबाएं।","easy.sayJoin":"आपको दिए गए छह अंक लिखें।","easy.sayChat":"जुड़ गए। अब आप बात कर सकते हैं।",
...
"home.bigStart":"কারও সঙ্গে কথা বলুন","home.bigAddrD":"এখানে লিখুন আর কল করুন","home.bigBook":"পরিচিতি","home.bigBookD":"যাদের সাথে আপনি কথা বলেছেন","home.joinLink":"আমন্ত্রণ খুলছে না? লিঙ্কটি এখানে পেস্ট করুন","home.bigStartD":"পাঠানোর জন্য আমন্ত্রণ তৈরি করুন","set.lang":"ভাষা","set.grpYou":"আপনি কে","set.grpAdv":"আরও","set.textsize":"লেখার আকার","conn.direct":"দুই ফোনের মধ্যে সরাসরি সংযোগ","conn.directShort":"সরাসরি যুক্ত","conn.relay":"এনক্রিপ্টেড সেতুর মাধ্যমে নিরাপদ সংযোগ","conn.relayShort":"যুক্ত (সেতু)","conn.down":"সংযোগ বিচ্ছিন্ন","conn.downShort":"বিচ্ছিন্ন","conn.working":"সংযোগ হচ্ছে","conn.wobbly":"সংযোগ টলে গেছে — আবার জুড়ছি","conn.wobblyShort":"আবার জুড়ছি","chat.linkLost":"সংযোগ বিচ্ছিন্ন হয়েছে। কিছুই হারায়নি।","chat.backHome":"হোমে ফিরে যান","chat.stillWobbly":"সংযোগ এখনও ফিরে আসেনি। আপনি আরও অপেক্ষা করতে পারেন, অথবা হোমে ফিরে গিয়ে আবার চেষ্টা করতে পারেন।",
...
"home.bigStart":"Bicara dengan seseorang","home.bigAddrD":"Ketik di sini lalu hubungi","home.bigBook":"Kontak","home.bigBookD":"Orang-orang yang pernah kamu ajak bicara","home.joinLink":"Undangan tidak terbuka? Tempel tautannya di sini","home.bigStartD":"Buat undangan untuk dikirim","set.lang":"Bahasa","set.grpYou":"Siapa Anda","set.grpAdv":"Lainnya","set.textsize":"Ukuran teks","conn.direct":"Sambungan langsung antara kedua ponsel","conn.directShort":"tersambung langsung","conn.relay":"Sambungan aman lewat jembatan terenkripsi","conn.relayShort":"tersambung (jembatan)","conn.down":"Sambungan terputus","conn.downShort":"terputus","conn.working":"Menyambungkan","conn.wobbly":"Sambungan goyah — sedang dipulihkan","conn.wobblyShort":"memulihkan","chat.linkLost":"Sambungan terputus. Tidak ada yang hilang.","chat.backHome":"Kembali ke beranda","chat.stillWobbly":"Sambungan belum kembali. Anda bisa terus menunggu, atau kembali ke beranda dan coba lagi.",
...
/* ============================== how the app is doing ==============================
   ...
   guessing. */
const APP_VERSION = 'logos-modifica-4.46';
