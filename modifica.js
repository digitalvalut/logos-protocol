...
"letter.title":"Messages left for you","letter.noneTitle":"Nobody is answering right now.","knock.note2":"Write them a couple of lines instead","letter.directTitle":"A couple of lines, without calling.","letter.directSub":"Text only, up to 300 characters: no photos or video. They'll find it as soon as they open the app, within seven days.","letter.noneSub":"I've already let them know you tried to reach them. If you want to say more, write it here.","letter.ph":"Write your message here","letter.leave":"Leave the message","letter.cancel":"Never mind","letter.needText":"Write a line or two, so they know what you wanted.","letter.left":"Message left. They'll find it when they open the app.","letter.failed":"I couldn't leave the message. Try again.","letter.noKey":"This address is no longer active, so the message cannot go out. Ask them to send it to you again — trying again would not help.","letter.callBack":"Call back","letter.dismiss":"Done","letter.reply":"Reply with a couple of lines","letter.arrived":"Someone left you a couple of lines.","net.title":"Where you speak from","net.sub":"With people you don't know, nobody sees where you speak from: the call goes through the encrypted bridge. With your contacts it is direct and faster. You can change that here.","net.normale":"Normal (recommended)","net.normaleSub":"With people you don't know, nobody sees where you speak from. With your contacts the call is direct.","net.sempre":"Always hide","net.sempreSub":"Even with your contacts the call goes through the bridge. A little slower.","net.tor":"With Tor (Orbot)","net.torSub":"Nobody sees where you speak from, not even us. Calls start a few seconds later and may be less smooth. Needs the free Orbot app.","net.torOpen":"Turn on Orbot","net.torInstall":"Install Orbot","net.torOn":"On Tor ✔ — nobody sees where you speak from.","net.torOff":"Not on Tor yet: open Orbot, turn on VPN mode and pick Logos.","net.torUnknown":"Checking…","net.torFail":"I can't open Orbot on this phone.","net.vpnNote":"If you already use a VPN, there is nothing to do: Logos goes through it.","call.viaTor":"via Tor · slower, more private","net.torNoAndroid":"From a browser Logos cannot turn Tor on by itself. On an Android phone, inside the Logos app, there is a button that does it: install Orbot from there.","net.torWhere":"Orbot is free, by Tor Project: download it from torproject.org",
...
"letter.title":"Messaggi lasciati per te","letter.noneTitle":"Non risponde nessuno adesso.","knock.note2":"Scrivigli due righe invece","letter.directTitle":"Due righe, senza chiamare.","letter.directSub":"Solo testo, fino a 300 caratteri: niente foto né video. Le trova appena apre l'app, entro sette giorni.","letter.noneSub":"Le ho già segnato che l'hai cercata. Se vuoi dirle qualcosa in più, scrivilo qui.","letter.ph":"Scrivi qui il tuo messaggio","letter.leave":"Lascia il messaggio","letter.cancel":"Lascia perdere","letter.needText":"Scrivi due parole, così sa cosa volevi.","letter.left":"Messaggio lasciato. Lo troverà appena apre l'app.","letter.failed":"Non sono riuscito a lasciare il messaggio. Riprova.","letter.noKey":"Questo indirizzo non risulta più attivo, quindi il messaggio non può partire. Chiedi alla persona di rimandartelo: riprovare non servirebbe.","letter.callBack":"Richiama","letter.dismiss":"Fatto","letter.reply":"Rispondi con due righe","letter.arrived":"Qualcuno ti ha lasciato due righe.","net.title":"Da dove parli","net.sub":"Con chi non conosci, nessuno vede da dove parli: la chiamata passa dal ponte cifrato. Con i tuoi contatti è diretta e più veloce. Qui puoi cambiare.","net.normale":"Normale (consigliato)","net.normaleSub":"Con chi non conosci, nessuno vede da dove parli. Con i tuoi contatti la chiamata è diretta.","net.sempre":"Nascondi sempre","net.sempreSub":"Anche con i tuoi contatti la chiamata passa dal ponte. Un po' più lenta.","net.tor":"Con Tor (Orbot)","net.torSub":"Nessuno vede da dove parli, nemmeno noi. Le chiamate partono qualche secondo più tardi e possono essere meno fluide. Serve l'app gratuita Orbot.","net.torOpen":"Accendi Orbot","net.torInstall":"Installa Orbot","net.torOn":"Su Tor ✔ — nessuno vede da dove parli.","net.torOff":"Non ancora su Tor: apri Orbot, attiva la modalità VPN e scegli Logos.","net.torUnknown":"Sto controllando…","net.torFail":"Non riesco ad aprire Orbot su questo telefono.","net.vpnNote":"Se usi già una VPN, non devi fare niente: Logos ci passa dentro.","call.viaTor":"via Tor · più lenta, più riservata","net.torNoAndroid":"Da un browser Logos non può accendere Tor da solo. Sul telefono Android, dentro l'app Logos, c'è il tasto che lo fa: installa Orbot da lì.","net.torWhere":"Orbot è gratuito, di Tor Project: si scarica da torproject.org",
...
"letter.title":"Messages laissés pour vous","letter.noneTitle":"Personne ne répond pour le moment.","knock.note2":"Écrivez-lui deux lignes plutôt","letter.directTitle":"Deux lignes, sans appeler.","letter.directSub":"Texte seulement, jusqu'à 300 caractères : ni photos ni vidéos. La personne les trouvera dès qu'elle ouvrira l'application, sous sept jours.","letter.noneSub":"Je lui ai déjà fait savoir que vous avez essayé de la joindre. Si vous voulez en dire plus, écrivez-le ici.","letter.ph":"Écrivez votre message ici","letter.leave":"Laisser le message","letter.cancel":"Laisser tomber","letter.needText":"Écrivez deux mots, qu'elle sache ce que vous vouliez.","letter.left":"Message laissé. La personne le trouvera en ouvrant l'application.","letter.failed":"Je n'ai pas pu laisser le message. Réessayez.","letter.noKey":"Cette adresse n'est plus active, le message ne peut donc pas partir. Demandez à la personne de vous la renvoyer : réessayer ne servirait à rien.","letter.callBack":"Rappeler","letter.dismiss":"Terminé","letter.reply":"Répondre en deux lignes","letter.arrived":"Quelqu’un vous a laissé deux lignes.","net.title":"D'où vous parlez","net.sub":"Avec les inconnus, personne ne voit d'où vous parlez : l'appel passe par le pont chiffré. Avec vos contacts il est direct et plus rapide. Vous pouvez changer ici.","net.normale":"Normal (recommandé)","net.normaleSub":"Avec les inconnus, personne ne voit d'où vous parlez. Avec vos contacts l'appel est direct.","net.sempre":"Toujours masquer","net.sempreSub":"Même avec vos contacts, l'appel passe par le pont. Un peu plus lent.","net.tor":"Avec Tor (Orbot)","net.torSub":"Personne ne voit d'où vous parlez, pas même nous. Les appels démarrent quelques secondes plus tard et peuvent être moins fluides. Nécessite l'application gratuite Orbot.","net.torOpen":"Activer Orbot","net.torInstall":"Installer Orbot","net.torOn":"Sur Tor ✔ — personne ne voit d'où vous parlez.","net.torOff":"Pas encore sur Tor : ouvrez Orbot, activez le mode VPN et choisissez Logos.","net.torUnknown":"Vérification…","net.torFail":"Impossible d'ouvrir Orbot sur ce téléphone.","net.vpnNote":"Si vous utilisez déjà un VPN, rien à faire : Logos passe dedans.","call.viaTor":"via Tor · plus lent, plus discret","net.torNoAndroid":"Depuis un navigateur, Logos ne peut pas activer Tor tout seul. Sur un téléphone Android, dans l'application Logos, un bouton le fait : installez Orbot depuis là.","net.torWhere":"Orbot est gratuit, par Tor Project : à télécharger sur torproject.org",
...
"letter.title":"Nachrichten für dich","letter.noneTitle":"Gerade antwortet niemand.","knock.note2":"Schreib ihm stattdessen zwei Zeilen","letter.directTitle":"Zwei Zeilen, ohne anzurufen.","letter.directSub":"Nur Text, bis zu 300 Zeichen: keine Fotos, keine Videos. Die Person findet sie, sobald sie die App öffnet, innerhalb von sieben Tagen.","letter.noneSub":"Ich habe ihr schon mitgeteilt, dass du sie erreichen wolltest. Wenn du mehr sagen willst, schreib es hier.","letter.ph":"Schreib deine Nachricht hier","letter.leave":"Nachricht hinterlassen","letter.cancel":"Doch nicht","letter.needText":"Schreib zwei Zeilen, damit sie weiß, worum es ging.","letter.left":"Nachricht hinterlassen. Sie wird sie beim Öffnen der App finden.","letter.failed":"Ich konnte die Nachricht nicht hinterlassen. Versuch es nochmal.","letter.noKey":"Diese Adresse ist nicht mehr aktiv, die Nachricht kann also nicht raus. Bitte die Person, sie dir noch einmal zu schicken — erneut versuchen hilft nicht.","letter.callBack":"Zurückrufen","letter.dismiss":"Erledigt","letter.reply":"Mit zwei Zeilen antworten","letter.arrived":"Jemand hat dir zwei Zeilen hinterlassen.","net.title":"Von wo du sprichst","net.sub":"Bei Unbekannten sieht niemand, von wo du sprichst: der Anruf läuft über die verschlüsselte Brücke. Bei deinen Kontakten ist er direkt und schneller. Hier kannst du das ändern.","net.normale":"Normal (empfohlen)","net.normaleSub":"Bei Unbekannten sieht niemand, von wo du sprichst. Bei deinen Kontakten ist der Anruf direkt.","net.sempre":"Immer verbergen","net.sempreSub":"Auch bei deinen Kontakten läuft der Anruf über die Brücke. Etwas langsamer.","net.tor":"Mit Tor (Orbot)","net.torSub":"Niemand sieht, von wo du sprichst, auch wir nicht. Anrufe starten ein paar Sekunden später und können weniger flüssig sein. Braucht die kostenlose App Orbot.","net.torOpen":"Orbot einschalten","net.torInstall":"Orbot installieren","net.torOn":"Über Tor ✔ — niemand sieht, von wo du sprichst.","net.torOff":"Noch nicht über Tor: öffne Orbot, schalte den VPN-Modus ein und wähle Logos.","net.torUnknown":"Prüfe…","net.torFail":"Ich kann Orbot auf diesem Telefon nicht öffnen.","net.vpnNote":"Wenn du schon ein VPN nutzt, musst du nichts tun: Logos läuft hindurch.","call.viaTor":"über Tor · langsamer, vertraulicher","net.torNoAndroid":"Aus einem Browser kann Logos Tor nicht selbst einschalten. Auf einem Android-Telefon, in der Logos-App, gibt es dafür einen Knopf: installiere Orbot von dort.","net.torWhere":"Orbot ist kostenlos, vom Tor Project: Download auf torproject.org",
...
"letter.title":"Mensajes que te han dejado","letter.noneTitle":"Ahora mismo no contesta nadie.","knock.note2":"Escríbele dos líneas en su lugar","letter.directTitle":"Dos líneas, sin llamar.","letter.directSub":"Solo texto, hasta 300 caracteres: ni fotos ni vídeos. Las encontrará en cuanto abra la aplicación, dentro de siete días.","letter.noneSub":"Ya le he avisado de que has intentado localizarla. Si quieres decirle algo más, escríbelo aquí.","letter.ph":"Escribe aquí tu mensaje","letter.leave":"Dejar el mensaje","letter.cancel":"Déjalo","letter.needText":"Escribe dos palabras, así sabrá qué querías.","letter.left":"Mensaje dejado. Lo encontrará al abrir la aplicación.","letter.failed":"No he podido dejar el mensaje. Inténtalo otra vez.","letter.noKey":"Esta dirección ya no está activa, así que el mensaje no puede salir. Pídele que te la vuelva a enviar: volver a intentarlo no serviría.","letter.callBack":"Devolver la llamada","letter.dismiss":"Hecho","letter.reply":"Responder con dos líneas","letter.arrived":"Alguien te ha dejado dos líneas.","net.title":"Desde dónde hablas","net.sub":"Con quien no conoces, nadie ve desde dónde hablas: la llamada pasa por el puente cifrado. Con tus contactos es directa y más rápida. Aquí puedes cambiarlo.","net.normale":"Normal (recomendado)","net.normaleSub":"Con quien no conoces, nadie ve desde dónde hablas. Con tus contactos la llamada es directa.","net.sempre":"Ocultar siempre","net.sempreSub":"También con tus contactos la llamada pasa por el puente. Un poco más lenta.","net.tor":"Con Tor (Orbot)","net.torSub":"Nadie ve desde dónde hablas, ni siquiera nosotros. Las llamadas empiezan unos segundos más tarde y pueden ser menos fluidas. Hace falta la app gratuita Orbot.","net.torOpen":"Encender Orbot","net.torInstall":"Instalar Orbot","net.torOn":"En Tor ✔ — nadie ve desde dónde hablas.","net.torOff":"Aún no en Tor: abre Orbot, activa el modo VPN y elige Logos.","net.torUnknown":"Comprobando…","net.torFail":"No consigo abrir Orbot en este teléfono.","net.vpnNote":"Si ya usas una VPN, no hay que hacer nada: Logos pasa por dentro.","call.viaTor":"vía Tor · más lenta, más reservada","net.torNoAndroid":"Desde un navegador Logos no puede encender Tor por sí solo. En un teléfono Android, dentro de la app Logos, hay un botón que lo hace: instala Orbot desde allí.","net.torWhere":"Orbot es gratis, de Tor Project: se descarga en torproject.org",
...
"letter.title":"Mensagens deixadas para si","letter.noneTitle":"Ninguém está a responder agora.","knock.note2":"Escreva-lhe duas linhas em vez disso","letter.directTitle":"Duas linhas, sem ligar.","letter.directSub":"Apenas texto, até 300 caracteres: sem fotografias nem vídeos. Encontra-as assim que abrir a aplicação, dentro de sete dias.","letter.noneSub":"Já lhe avisei de que tentou contactá-la. Se quiser dizer mais alguma coisa, escreva aqui.","letter.ph":"Escreva aqui a sua mensagem","letter.leave":"Deixar a mensagem","letter.cancel":"Deixe estar","letter.needText":"Escreva duas palavras, para saber o que queria.","letter.left":"Mensagem deixada. Vai encontrá-la ao abrir a aplicação.","letter.failed":"Não consegui deixar a mensagem. Tente de novo.","letter.noKey":"Este endereço já não está ativo, por isso a mensagem não pode sair. Peça à pessoa que lho envie de novo: tentar outra vez não adiantaria.","letter.callBack":"Ligar de volta","letter.dismiss":"Feito","letter.reply":"Responder com duas linhas","letter.arrived":"Alguém lhe deixou duas linhas.","net.title":"De onde fala","net.sub":"Com quem não conhece, ninguém vê de onde fala: a chamada passa pela ponte cifrada. Com os seus contactos é direta e mais rápida. Aqui pode mudar.","net.normale":"Normal (recomendado)","net.normaleSub":"Com quem não conhece, ninguém vê de onde fala. Com os seus contactos a chamada é direta.","net.sempre":"Ocultar sempre","net.sempreSub":"Também com os seus contactos a chamada passa pela ponte. Um pouco mais lenta.","net.tor":"Com Tor (Orbot)","net.torSub":"Ninguém vê de onde fala, nem nós. As chamadas começam alguns segundos mais tarde e podem ser menos fluidas. Precisa da app gratuita Orbot.","net.torOpen":"Ligar o Orbot","net.torInstall":"Instalar o Orbot","net.torOn":"Em Tor ✔ — ninguém vê de onde fala.","net.torOff":"Ainda não em Tor: abra o Orbot, ative o modo VPN e escolha o Logos.","net.torUnknown":"A verificar…","net.torFail":"Não consigo abrir o Orbot neste telemóvel.","net.vpnNote":"Se já usa uma VPN, não há nada a fazer: o Logos passa por dentro.","call.viaTor":"via Tor · mais lenta, mais reservada","net.torNoAndroid":"A partir de um browser o Logos não consegue ligar o Tor sozinho. Num telemóvel Android, dentro da app Logos, há um botão que o faz: instale o Orbot a partir daí.","net.torWhere":"O Orbot é gratuito, do Tor Project: descarrega-se em torproject.org",
...
"letter.title":"Оставленные вам сообщения","letter.noneTitle":"Сейчас никто не отвечает.","knock.note2":"Напишите пару строк вместо звонка","letter.directTitle":"Пара строк, без звонка.","letter.directSub":"Только текст, до 300 знаков: без фото и видео. Человек увидит их, как только откроет приложение, в течение семи дней.","letter.noneSub":"Я уже сообщил ей, что вы пытались до неё дозвониться. Если хотите сказать больше, напишите здесь.","letter.ph":"Напишите сообщение здесь","letter.leave":"Оставить сообщение","letter.cancel":"Не надо","letter.needText":"Напишите пару слов, чтобы было понятно, зачем вы звонили.","letter.left":"Сообщение оставлено. Его увидят при открытии приложения.","letter.failed":"Не удалось оставить сообщение. Попробуйте ещё раз.","letter.noKey":"Этот адрес больше не активен, поэтому сообщение не уйдёт. Попросите прислать его заново — повторять бесполезно.","letter.callBack":"Перезвонить","letter.dismiss":"Готово","letter.reply":"Ответить парой строк","letter.arrived":"Кто-то оставил вам пару строк.","net.title":"Откуда вы говорите","net.sub":"С незнакомыми никто не видит, откуда вы говорите: звонок идёт через зашифрованный мост. С вашими контактами он прямой и быстрее. Здесь это можно изменить.","net.normale":"Обычный (рекомендуется)","net.normaleSub":"С незнакомыми никто не видит, откуда вы говорите. С контактами звонок прямой.","net.sempre":"Всегда скрывать","net.sempreSub":"Даже с контактами звонок идёт через мост. Чуть медленнее.","net.tor":"Через Tor (Orbot)","net.torSub":"Никто не видит, откуда вы говорите, даже мы. Звонки начинаются на несколько секунд позже и могут быть менее плавными. Нужно бесплатное приложение Orbot.","net.torOpen":"Включить Orbot","net.torInstall":"Установить Orbot","net.torOn":"Через Tor ✔ — никто не видит, откуда вы говорите.","net.torOff":"Пока не через Tor: откройте Orbot, включите режим VPN и выберите Logos.","net.torUnknown":"Проверяю…","net.torFail":"Не удаётся открыть Orbot на этом телефоне.","net.vpnNote":"Если вы уже используете VPN, ничего делать не нужно: Logos идёт через него.","call.viaTor":"через Tor · медленнее, приватнее","net.torNoAndroid":"Из браузера Logos не может включить Tor сам. На телефоне Android, внутри приложения Logos, есть кнопка для этого: установите Orbot оттуда.","net.torWhere":"Orbot бесплатен, от Tor Project: скачайте на torproject.org",
...
"letter.title":"留给你的消息","letter.noneTitle":"现在没有人接听。","knock.note2":"改成给他写两行字","letter.directTitle":"两行字，不用打电话。","letter.directSub":"只有文字，最多 300 个字符：不能发照片和视频。对方一打开应用就能看到，七天内有效。","letter.noneSub":"我已经告诉对方你找过她了。如果你想多说几句，可以写在这里。","letter.ph":"在这里写下你的消息","letter.leave":"留下消息","letter.cancel":"算了","letter.needText":"写上一两句，让对方知道你想说什么。","letter.left":"消息已留下。对方打开应用就会看到。","letter.failed":"没能留下消息，请再试一次。","letter.noKey":"这个地址已经不再有效，消息发不出去。请对方重新发一次给你——重试没有用。","letter.callBack":"回拨","letter.dismiss":"完成","letter.reply":"回复两行字","letter.arrived":"有人给你留了两行字。","net.title":"你从哪里通话","net.sub":"和陌生人通话时，没有人能看到你从哪里通话：通话经过加密中转。和联系人通话则是直连、更快。你可以在这里更改。","net.normale":"普通（推荐）","net.normaleSub":"和陌生人通话时，没有人能看到你从哪里通话。和联系人通话则是直连。","net.sempre":"始终隐藏","net.sempreSub":"和联系人通话也经过中转。稍慢一些。","net.tor":"使用 Tor（Orbot）","net.torSub":"没有人能看到你从哪里通话，包括我们。通话会晚几秒开始，可能不太流畅。需要免费应用 Orbot。","net.torOpen":"打开 Orbot","net.torInstall":"安装 Orbot","net.torOn":"已通过 Tor ✔ — 没有人能看到你从哪里通话。","net.torOff":"尚未通过 Tor：打开 Orbot，启用 VPN 模式并选择 Logos。","net.torUnknown":"正在检查……","net.torFail":"无法在此手机上打开 Orbot。","net.vpnNote":"如果你已经在用 VPN，无需任何操作：Logos 会通过它。","call.viaTor":"经由 Tor · 更慢，更私密","net.torNoAndroid":"在浏览器里 Logos 无法自行开启 Tor。在 Android 手机的 Logos 应用里有一个按钮可以做到：从那里安装 Orbot。","net.torWhere":"Orbot 免费，由 Tor Project 提供：从 torproject.org 下载",
...
"letter.title":"رسائل تُركت لك","letter.noneTitle":"لا أحد يردّ الآن.","knock.note2":"اكتب له سطرين بدلاً من ذلك","letter.directTitle":"سطران، بدون اتصال.","letter.directSub":"نص فقط، حتى 300 حرف: بدون صور أو فيديو. سيجدهما بمجرد فتح التطبيق، خلال سبعة أيام.","letter.noneSub":"أخبرتها بالفعل أنك حاولت الوصول إليها. إذا أردت أن تقول المزيد، اكتبه هنا.","letter.ph":"اكتب رسالتك هنا","letter.leave":"اترك الرسالة","letter.cancel":"لا بأس","letter.needText":"اكتب كلمتين ليعرف ماذا أردت.","letter.left":"تُركت الرسالة. سيجدها عند فتح التطبيق.","letter.failed":"لم أتمكن من ترك الرسالة. حاول مرة أخرى.","letter.noKey":"لم يعد هذا العنوان نشطًا، لذا لا يمكن إرسال الرسالة. اطلب منه أن يرسله لك من جديد — إعادة المحاولة لن تفيد.","letter.callBack":"عاود الاتصال","letter.dismiss":"تم","letter.reply":"الرد بسطرين","letter.arrived":"ترك لك أحدهم سطرين.","net.title":"من أين تتحدث","net.sub":"مع من لا تعرفهم، لا أحد يرى من أين تتحدث: تمر المكالمة عبر الجسر المشفّر. مع جهات اتصالك تكون مباشرة وأسرع. يمكنك التغيير هنا.","net.normale":"عادي (موصى به)","net.normaleSub":"مع من لا تعرفهم، لا أحد يرى من أين تتحدث. مع جهات اتصالك المكالمة مباشرة.","net.sempre":"إخفاء دائمًا","net.sempreSub":"حتى مع جهات اتصالك تمر المكالمة عبر الجسر. أبطأ قليلاً.","net.tor":"عبر Tor (Orbot)","net.torSub":"لا أحد يرى من أين تتحدث، ولا حتى نحن. تبدأ المكالمات بعد ثوانٍ وقد تكون أقل سلاسة. يلزم تطبيق Orbot المجاني.","net.torOpen":"تشغيل Orbot","net.torInstall":"تثبيت Orbot","net.torOn":"عبر Tor ✔ — لا أحد يرى من أين تتحدث.","net.torOff":"لست على Tor بعد: افتح Orbot، فعّل وضع VPN واختر Logos.","net.torUnknown":"جارٍ التحقق…","net.torFail":"لا أستطيع فتح Orbot على هذا الهاتف.","net.vpnNote":"إن كنت تستخدم VPN بالفعل فلا شيء تفعله: يمر Logos عبره.","call.viaTor":"عبر Tor · أبطأ وأكثر خصوصية","net.torNoAndroid":"من المتصفح لا يستطيع Logos تشغيل Tor بنفسه. على هاتف أندرويد، داخل تطبيق Logos، هناك زر يفعل ذلك: ثبّت Orbot من هناك.","net.torWhere":"Orbot مجاني من Tor Project: حمّله من torproject.org",
...
"letter.title":"آپ کے لیے چھوڑے گئے پیغامات","letter.noneTitle":"ابھی کوئی جواب نہیں دے رہا۔","knock.note2":"اس کے بجائے دو سطریں لکھیں","letter.directTitle":"دو سطریں، کال کیے بغیر۔","letter.directSub":"صرف متن، زیادہ سے زیادہ 300 حروف: کوئی تصویر یا ویڈیو نہیں۔ ایپ کھولتے ہی مل جائیں گی، سات دن کے اندر۔","letter.noneSub":"میں انہیں پہلے ہی بتا چکا ہوں کہ آپ نے رابطہ کرنے کی کوشش کی۔ اگر مزید کچھ کہنا ہے تو یہاں لکھیں۔","letter.ph":"اپنا پیغام یہاں لکھیں","letter.leave":"پیغام چھوڑیں","letter.cancel":"رہنے دیں","letter.needText":"دو لفظ لکھ دیں تاکہ انہیں معلوم ہو آپ کیا چاہتے تھے۔","letter.left":"پیغام چھوڑ دیا گیا۔ ایپ کھولتے ہی مل جائے گا۔","letter.failed":"میں پیغام نہیں چھوڑ سکا۔ دوبارہ کوشش کریں۔","letter.noKey":"یہ پتہ اب فعال نہیں رہا، اس لیے پیغام نہیں جا سکتا۔ اُن سے دوبارہ بھیجنے کو کہیں — دوبارہ کوشش سے کچھ نہیں ہوگا۔","letter.callBack":"واپس کال کریں","letter.dismiss":"ہو گیا","letter.reply":"دو سطروں میں جواب دیں","letter.arrived":"کسی نے آپ کے لیے دو سطریں چھوڑی ہیں۔","net.title":"آپ کہاں سے بات کر رہے ہیں","net.sub":"اجنبیوں کے ساتھ کوئی نہیں دیکھتا کہ آپ کہاں سے بات کر رہے ہیں: کال خفیہ پل سے گزرتی ہے۔ اپنے رابطوں کے ساتھ براہِ راست اور تیز ہے۔ یہاں بدل سکتے ہیں۔","net.normale":"عام (تجویز کردہ)","net.normaleSub":"اجنبیوں کے ساتھ کوئی نہیں دیکھتا کہ آپ کہاں سے ہیں۔ رابطوں کے ساتھ کال براہِ راست ہے۔","net.sempre":"ہمیشہ چھپائیں","net.sempreSub":"رابطوں کے ساتھ بھی کال پل سے گزرتی ہے۔ تھوڑی سست۔","net.tor":"Tor کے ساتھ (Orbot)","net.torSub":"کوئی نہیں دیکھتا آپ کہاں سے بات کر رہے ہیں، ہم بھی نہیں۔ کالیں چند سیکنڈ دیر سے شروع ہوتی ہیں اور کم رواں ہو سکتی ہیں۔ مفت ایپ Orbot درکار ہے۔","net.torOpen":"Orbot آن کریں","net.torInstall":"Orbot انسٹال کریں","net.torOn":"Tor پر ✔ — کوئی نہیں دیکھتا آپ کہاں سے ہیں۔","net.torOff":"ابھی Tor پر نہیں: Orbot کھولیں، VPN موڈ آن کریں اور Logos چنیں۔","net.torUnknown":"جانچ رہا ہوں…","net.torFail":"اس فون پر Orbot نہیں کھول سکتا۔","net.vpnNote":"اگر آپ پہلے سے VPN استعمال کرتے ہیں تو کچھ نہیں کرنا: Logos اسی سے گزرتا ہے۔","call.viaTor":"Tor کے ذریعے · سست، زیادہ نجی","net.torNoAndroid":"براؤزر سے Logos خود Tor آن نہیں کر سکتا۔ اینڈرائیڈ فون پر، Logos ایپ کے اندر، اس کے لیے بٹن ہے: وہاں سے Orbot انسٹال کریں۔","net.torWhere":"Orbot مفت ہے، Tor Project کا: torproject.org سے ڈاؤن لوڈ کریں",
...
"letter.title":"आपके लिए छोड़े गए संदेश","letter.noneTitle":"अभी कोई जवाब नहीं दे रहा।","knock.note2":"इसके बजाय दो पंक्तियाँ लिखें","letter.directTitle":"दो पंक्तियाँ, बिना कॉल किए।","letter.directSub":"केवल टेक्स्ट, अधिकतम 300 अक्षर: कोई फ़ोटो या वीडियो नहीं। ऐप खोलते ही मिल जाएँगी, सात दिनों के भीतर।","letter.noneSub":"मैं उसे पहले ही बता चुका हूँ कि आपने संपर्क करने की कोशिश की। अगर कुछ और कहना है तो यहाँ लिखें।","letter.ph":"अपना संदेश यहाँ लिखें","letter.leave":"संदेश छोड़ें","letter.cancel":"रहने दें","letter.needText":"दो शब्द लिख दें, ताकि उन्हें पता चले आप क्या चाहते थे।","letter.left":"संदेश छोड़ दिया। ऐप खोलते ही उन्हें मिल जाएगा।","letter.failed":"मैं संदेश नहीं छोड़ सका। फिर कोशिश करें।","letter.noKey":"यह पता अब सक्रिय नहीं है, इसलिए संदेश नहीं जा सकता। उनसे दोबारा भेजने को कहें — फिर से कोशिश करने से कुछ नहीं होगा।","letter.callBack":"वापस कॉल करें","letter.dismiss":"हो गया","letter.reply":"दो पंक्तियों में जवाब दें","letter.arrived":"किसी ने आपके लिए दो पंक्तियाँ छोड़ी हैं।","net.title":"आप कहाँ से बात करते हैं","net.sub":"अनजान लोगों के साथ कोई नहीं देखता कि आप कहाँ से बात करते हैं: कॉल एन्क्रिप्टेड पुल से जाती है। अपने संपर्कों के साथ सीधी और तेज़। यहाँ बदल सकते हैं।","net.normale":"सामान्य (अनुशंसित)","net.normaleSub":"अनजान लोगों के साथ कोई नहीं देखता कि आप कहाँ से हैं। संपर्कों के साथ कॉल सीधी है।","net.sempre":"हमेशा छिपाएँ","net.sempreSub":"संपर्कों के साथ भी कॉल पुल से जाती है। थोड़ी धीमी।","net.tor":"Tor के साथ (Orbot)","net.torSub":"कोई नहीं देखता कि आप कहाँ से बात करते हैं, हम भी नहीं। कॉल कुछ सेकंड देर से शुरू होती हैं और कम सहज हो सकती हैं। मुफ़्त ऐप Orbot चाहिए।","net.torOpen":"Orbot चालू करें","net.torInstall":"Orbot इंस्टॉल करें","net.torOn":"Tor पर ✔ — कोई नहीं देखता आप कहाँ से हैं।","net.torOff":"अभी Tor पर नहीं: Orbot खोलें, VPN मोड चालू करें और Logos चुनें।","net.torUnknown":"जाँच रहा हूँ…","net.torFail":"इस फ़ोन पर Orbot नहीं खोल पा रहा।","net.vpnNote":"अगर आप पहले से VPN इस्तेमाल करते हैं तो कुछ नहीं करना: Logos उसी से जाता है।","call.viaTor":"Tor के ज़रिये · धीमी, ज़्यादा निजी","net.torNoAndroid":"ब्राउज़र से Logos खुद Tor चालू नहीं कर सकता। Android फ़ोन पर, Logos ऐप के अंदर, इसके लिए बटन है: वहीं से Orbot इंस्टॉल करें।","net.torWhere":"Orbot मुफ़्त है, Tor Project का: torproject.org से डाउनलोड करें",
...
"letter.title":"আপনার জন্য রাখা বার্তা","letter.noneTitle":"এখন কেউ সাড়া দিচ্ছে না।","knock.note2":"বরং দুই লাইন লিখুন","letter.directTitle":"দুই লাইন, কল না করেই।","letter.directSub":"শুধু লেখা, সর্বোচ্চ ৩০০ অক্ষর: ছবি বা ভিডিও নয়। অ্যাপ খুললেই পেয়ে যাবেন, সাত দিনের মধ্যে।","letter.noneSub":"আমি তাকে আগেই জানিয়ে দিয়েছি যে আপনি তার সঙ্গে যোগাযোগের চেষ্টা করেছেন। আরও কিছু বলতে চাইলে এখানে লিখুন।","letter.ph":"আপনার বার্তা এখানে লিখুন","letter.leave":"বার্তা রাখুন","letter.cancel":"থাক","letter.needText":"দু-এক কথা লিখুন, যাতে বোঝেন আপনি কী চেয়েছিলেন।","letter.left":"বার্তা রাখা হয়েছে। অ্যাপ খুললেই দেখতে পাবেন।","letter.failed":"বার্তা রাখতে পারিনি। আবার চেষ্টা করুন।","letter.noKey":"এই ঠিকানাটি আর সক্রিয় নেই, তাই বার্তা যেতে পারবে না। তাঁকে আবার পাঠাতে বলুন — আবার চেষ্টা করে লাভ নেই।","letter.callBack":"ফিরে ডাকুন","letter.dismiss":"হয়েছে","letter.reply":"দুই লাইনে উত্তর দিন","letter.arrived":"কেউ আপনার জন্য দুই লাইন রেখে গেছে।","net.title":"আপনি কোথা থেকে কথা বলছেন","net.sub":"অচেনাদের সাথে কেউ দেখে না আপনি কোথা থেকে কথা বলছেন: কল এনক্রিপ্টেড সেতু দিয়ে যায়। আপনার পরিচিতদের সাথে সরাসরি ও দ্রুত। এখানে বদলাতে পারেন।","net.normale":"সাধারণ (প্রস্তাবিত)","net.normaleSub":"অচেনাদের সাথে কেউ দেখে না আপনি কোথায়। পরিচিতদের সাথে কল সরাসরি।","net.sempre":"সবসময় লুকান","net.sempreSub":"পরিচিতদের সাথেও কল সেতু দিয়ে যায়। একটু ধীর।","net.tor":"Tor সহ (Orbot)","net.torSub":"কেউ দেখে না আপনি কোথা থেকে কথা বলছেন, আমরাও না। কল কয়েক সেকেন্ড দেরিতে শুরু হয় এবং কম মসৃণ হতে পারে। বিনামূল্যের অ্যাপ Orbot লাগবে।","net.torOpen":"Orbot চালু করুন","net.torInstall":"Orbot ইনস্টল করুন","net.torOn":"Tor-এ ✔ — কেউ দেখে না আপনি কোথায়।","net.torOff":"এখনও Tor-এ নয়: Orbot খুলুন, VPN মোড চালু করুন এবং Logos বেছে নিন।","net.torUnknown":"যাচাই করছি…","net.torFail":"এই ফোনে Orbot খুলতে পারছি না।","net.vpnNote":"আপনি যদি আগে থেকেই VPN ব্যবহার করেন, কিছু করতে হবে না: Logos তার মধ্য দিয়েই যায়।","call.viaTor":"Tor-এর মাধ্যমে · ধীর, বেশি গোপন","net.torNoAndroid":"ব্রাউজার থেকে Logos নিজে Tor চালু করতে পারে না। Android ফোনে, Logos অ্যাপের ভেতরে, এর জন্য একটি বোতাম আছে: সেখান থেকে Orbot ইনস্টল করুন।","net.torWhere":"Orbot বিনামূল্যে, Tor Project-এর: torproject.org থেকে ডাউনলোড করুন",
...
"letter.title":"Pesan yang ditinggalkan untuk Anda","letter.noneTitle":"Sekarang tidak ada yang menjawab.","knock.note2":"Tulis saja dua baris untuknya","letter.directTitle":"Dua baris, tanpa menelepon.","letter.directSub":"Hanya teks, maksimal 300 karakter: tanpa foto atau video. Akan ditemukan begitu dia membuka aplikasi, dalam tujuh hari.","letter.noneSub":"Saya sudah memberi tahu dia bahwa Anda mencoba menghubunginya. Kalau mau bilang lebih banyak, tulis di sini.","letter.ph":"Tulis pesan Anda di sini","letter.leave":"Tinggalkan pesan","letter.cancel":"Tidak jadi","letter.needText":"Tulis satu dua kalimat, supaya dia tahu apa yang Anda mau.","letter.left":"Pesan ditinggalkan. Dia akan menemukannya saat membuka aplikasi.","letter.failed":"Saya tidak bisa meninggalkan pesan. Coba lagi.","letter.noKey":"Alamat ini sudah tidak aktif, jadi pesannya tidak bisa terkirim. Minta dia mengirimkannya lagi — mencoba lagi tidak akan membantu.","letter.callBack":"Telepon balik","letter.dismiss":"Selesai","letter.reply":"Balas dengan dua baris","letter.arrived":"Seseorang meninggalkan dua baris untukmu.","net.title":"Dari mana kamu berbicara","net.sub":"Dengan orang yang tidak kamu kenal, tidak ada yang melihat dari mana kamu berbicara: panggilan lewat jembatan terenkripsi. Dengan kontakmu, langsung dan lebih cepat. Bisa diubah di sini.","net.normale":"Normal (disarankan)","net.normaleSub":"Dengan orang asing, tidak ada yang melihat dari mana kamu berbicara. Dengan kontakmu, panggilan langsung.","net.sempre":"Selalu sembunyikan","net.sempreSub":"Dengan kontakmu pun panggilan lewat jembatan. Sedikit lebih lambat.","net.tor":"Dengan Tor (Orbot)","net.torSub":"Tidak ada yang melihat dari mana kamu berbicara, kami pun tidak. Panggilan mulai beberapa detik lebih lambat dan mungkin kurang lancar. Perlu aplikasi gratis Orbot.","net.torOpen":"Nyalakan Orbot","net.torInstall":"Pasang Orbot","net.torOn":"Lewat Tor ✔ — tidak ada yang melihat dari mana kamu berbicara.","net.torOff":"Belum lewat Tor: buka Orbot, nyalakan mode VPN, dan pilih Logos.","net.torUnknown":"Memeriksa…","net.torFail":"Tidak bisa membuka Orbot di ponsel ini.","net.vpnNote":"Kalau kamu sudah pakai VPN, tidak perlu apa-apa: Logos lewat di dalamnya.","call.viaTor":"lewat Tor · lebih lambat, lebih privat","net.torNoAndroid":"Dari browser, Logos tidak bisa menyalakan Tor sendiri. Di ponsel Android, di dalam aplikasi Logos, ada tombol untuk itu: pasang Orbot dari sana.","net.torWhere":"Orbot gratis, dari Tor Project: unduh di torproject.org",
...
/* ---- DA DOVE PARLI (v48, 15 set 2026) ----
   In una chiamata diretta chi ti chiama vede il tuo indirizzo di rete: e'
   inevitabile, i pacchetti partono da li'. Con un contatto fidato non importa;
   con uno sconosciuto — chi ti chiama dall'indirizzo in vetrina, da un
   indirizzo usa e getta, da un invito appena aperto — e' un dato che gli si
   regala. Dalla v48 la chiamata con chi NON e' in rubrica passa tutta dal
   ponte cifrato (iceTransportPolicy 'relay'): lui vede Cloudflare, non te. Il
   ponte non legge niente — la cifratura e' fra i due telefoni, e la strada
   del ponte esiste da sempre per le reti che non permettono il diretto: qui la
   si accende anche per gli altri. Con chi e' in rubrica la chiamata resta
   diretta, piu' veloce. E' la stessa regola di Signal («relay per chi non e'
   in rubrica»), e nessuno la vede: succede e basta.
   Tre scelte in Impostazioni → «Da dove parli»: normale (questa), sempre
   (ponte anche con i contatti), tor (come normale, ma la scheda accende Orbot
   e mostra se sei davvero su Tor). Deciso dall'operatore: «quella deve
   sparire agli occhi degli altri, su tutto». */
const NET_POLICY_KEY = 'dvlogos-net';
/* La spia «Su Tor»: non quello che hai scelto, quello che il relay VEDE. Cloudflare
   marca le richieste che arrivano da un'uscita di Tor, e il Worker lo dice in
   un'intestazione (X-Logos-Tor: 1). Si legge da ogni risposta del relay che
   passa di qui, e la scheda la mostra. null = non lo sappiamo ancora. */
let torSeen = null, torSeenAt = 0;
function noteTorHeader(res){
  try{
    const h = res && res.headers && res.headers.get && res.headers.get('X-Logos-Tor');
    if (h === null || h === undefined) return;   /* relay vecchio: non lo dice */
    torSeen = (h === '1'); torSeenAt = Date.now();
    paintNetCard();
  }catch(_){}
}
function netPolicy(){
  try{ const v = MEM.getItem(NET_POLICY_KEY); return v === 'sempre' || v === 'tor' ? v : 'normale'; }
  catch(e){ return 'normale'; }
}
function setNetPolicy(v){ try{ MEM.setItem(NET_POLICY_KEY, v === 'sempre' || v === 'tor' ? v : 'normale'); }catch(e){} }
/* `noto` = l'altro e' un contatto in rubrica. Torna true se questa connessione
   deve usare SOLO il ponte. */
function relayOnlyFor(noto){ return netPolicy() === 'sempre' || !noto; }
/* ---- la scheda «Da dove parli» ---- */
const androidTor = (() => {
  try{ return (typeof AndroidTor !== 'undefined' && AndroidTor && AndroidTor.available()) ? AndroidTor : null; }
  catch(_){ return null; }
})();
function paintNetCard(){
  ...
  if (!card) return;
  const p = netPolicy();
  for (const row of netRows()) row.setAttribute('aria-checked', row.getAttribute('data-net') === p ? 'true' : 'false');
  const tor = p === 'tor';
  $('netTorBox').classList.toggle('hide', !tor);
  /* il tasto: su Android con il ponte, «Accendi Orbot» o «Installa Orbot»;
     altrove (browser, iPhone) il tasto non ha senso e la scheda spiega a parole */
  let orbot = null;
  try{ orbot = androidTor ? androidTor.status() : null; }catch(_){ orbot = null; }
  $('btnOrbot').classList.toggle('hide', !androidTor);
  $('netTorNoAndroid').classList.toggle('hide', !!androidTor);
  setT($('btnOrbot'), orbot === 'installed' ? 'net.torOpen' : 'net.torInstall');
  if (!tor) return;
  const st = $('netTorStatus');
  if (torSeen === true) setStatus(st, t('net.torOn','Su Tor ✔ — nessuno vede da dove parli.'), 'ok');
  else if (torSeen === false) setStatus(st, t('net.torOff','Non ancora su Tor: apri Orbot, attiva la modalità VPN e scegli Logos.'), 'warn');
  else setStatus(st, t('net.torUnknown','Sto controllando…'));
  $('callViaTor').classList.toggle('hide', torSeen !== true);
}
function netRows(){
  const out = []; const giu = el => { for (const c of (el.children || [])){ if (c.classList && c.classList.contains('netrow')) out.push(c); giu(c); } };
  const card = $('netCard'); if (card) giu(card); return out;
}
function chooseNet(v){
  setNetPolicy(v);
  paintNetCard();
  /* scelto Tor: si va subito a vedere se ci siamo (la risposta del relay porta la spia) */
  if (v === 'tor'){ torSeen = null; loadIceServersNow().catch(() => {}); }
}
function isKnownFp(fp){ return typeof fp === 'string' && !!fp && loadContacts().some(c => c.fp === fp); }
function isKnownAddr(addr){ return typeof addr === 'string' && !!addr && loadContacts().some(c => c.addr === addr); }

async function newPeerConnection(opts){
  connectStartedAt = Date.now();
  const [cert, iceServers] = await Promise.all([myIdentity(), fetchIceServers()]);
  const config = { iceServers };
  /* solo il ponte: il browser non raccoglie ne' offre indirizzi propri, e i
     pacchetti verso l'altro partono dal ponte. Se il ponte manca la chiamata
     non parte, e non ripiega sul diretto: sarebbe tradire la promessa. */
  if (opts && opts.relayOnly) config.iceTransportPolicy = 'relay';
...
$('btnCreate').addEventListener('click', async () => {
  ...
  pc = await newPeerConnection({ relayOnly: relayOnlyFor(false) });   /* un invito: l'altro non e' in rubrica */
...
$('btnCreateAnswer').addEventListener('click', async () => {
  ...
  pc = await newPeerConnection({ relayOnly: relayOnlyFor(false) });
...
/* «Questa chiamata l'ho presa in mano io»: il campanello nativo smette e per
   un po' non risuona per la stessa busta (v48, le due regole in
   RingService.java). Detto quando l'app annuncia o accetta una chiamata
   all'indirizzo. Un ponte vecchio non ha il metodo: allora niente. */
function noteAndroidHandled(){
  if (!androidRing || typeof androidRing.handled !== 'function') return;
  try{ androidRing.handled(); }catch(_){}
}
...
async function acceptAddrCall(){
  ...
  try{
    stopQuickPump();
    /* chi chiama e' «noto» solo se la sua impronta e' gia' in rubrica: per
       gli altri, solo il ponte (vedi netPolicy) */
    pc = await newPeerConnection({ relayOnly: relayOnlyFor(isKnownFp(msg && msg.fp)) });
...
async function dialAddress(raw, unvouched){
  ...
  try{
    ...
    stopQuickPump();
    /* l'indirizzo chiamato e' «noto» se sta in rubrica (imparato da una
       chiamata provata): per gli sconosciuti, solo il ponte */
    pc = await newPeerConnection({ relayOnly: relayOnlyFor(isKnownAddr(addr)) });
    myPc = pc;
...
/* «Da dove parli» (v48): tre righe, una sola accesa; il tasto Orbot; la spia. */
for (const row of netRows()){
  const scegli = () => chooseNet(row.getAttribute('data-net'));
  row.addEventListener('click', scegli);
  row.addEventListener('keydown', e => { if (e.key === ' ' || e.key === 'Enter'){ e.preventDefault(); scegli(); } });
}
$('btnOrbot').addEventListener('click', () => {
  if (!androidTor) return;
  let esito = false;
  try{ esito = !!androidTor.open(); }catch(_){ esito = false; }
  if (!esito) toast(t('net.torFail','Non riesco ad aprire Orbot su questo telefono.'));
  /* Orbot ci mette qualche secondo a costruire la strada: si ricontrolla tra poco */
  torSeen = null; paintNetCard();
  setTimeout(() => { loadIceServersNow().catch(() => {}); }, 8000);
});
paintNetCard();
...
async function tryAutoReconnectInner(contact){
  ...
  stopQuickPump();
  pc = await newPeerConnection({ relayOnly: relayOnlyFor(true) });   /* un contatto: diretto, salvo «nascondi sempre» */
...
async function acceptIncomingAutoOffer(contact, msg, sec){
  ...
  try{
    stopQuickPump();
    const myFp = await myFingerprintHex();
    pc = await newPeerConnection({ relayOnly: relayOnlyFor(true) });   /* un contatto in rubrica */
...
async function tryQuickConnect(){
  ...
  try{
    ...
    const pcReady = newPeerConnection({ relayOnly: relayOnlyFor(false) });   /* un invito: chi lo ha fatto non e' in rubrica */
