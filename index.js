...
T.it = {
  ...
  'hero.apkUpdate': "Vuoi che si aggiorni da solo? Installalo con Obtainium.",
  ...
  'what.1b': "Chi ce l'ha ti raggiunge quando vuole, senza conoscere il tuo numero di telefono. Richiamarlo poi è un tocco solo.",
  ...
  'what.4t': "Manda i file come sono davvero",
  'what.4b': "Foto, video e documenti fino a 512 MB, più di uno alla volta, nella qualità originale — senza comprimerli.",
  'what.5t': "Mostra il tuo schermo mentre parlate",
  'what.5b': "Utile per aiutare a distanza chi ha meno familiarità con la tecnologia: vede il tuo schermo, tu gli dici dove toccare.",
  ...
  'foot.formal': "Il protocollo scritto per intero e i modelli di verifica formale (Tamarin, ProVerif): pubblici, rieseguibili, non ancora revisionati da terzi — cercasi revisore",
  'foot.vpn': "Funziona anche con una VPN, o con Tor tramite Orbot su Android: le chiamate partono qualche secondo più tardi, e nessuno vede da dove ti colleghi.",
  'foot.privacy': "Informativa sulla privacy",
  'foot.stato': "Stato del servizio: cosa risponde adesso",
  'hero.qr': "Inquadralo dal telefono",
  'hero.installa': "Come installarlo su Android, iPhone e computer — e come usarlo al massimo",
...
T.en = {
  ...
  'hero.apkUpdate': "Want it to keep itself up to date? Install it with Obtainium.",
  ...
  'what.1b': "Whoever holds it can reach you whenever they like, without knowing your phone number. Calling them again after that is one tap.",
  ...
  'what.4t': "Send files as they really are",
  'what.4b': "Photos, videos and documents up to 512 MB, several at once, at full original quality — never compressed.",
  'what.5t': "Show your screen while you talk",
  'what.5b': "Useful for helping someone less comfortable with technology from a distance: they see your screen, you tell them where to tap.",
  ...
  'foot.formal': "The protocol written out in full and the formal-verification models (Tamarin, ProVerif): public, re-runnable, not yet independently reviewed — reviewer wanted",
  'foot.vpn': "It also works over a VPN, or over Tor via Orbot on Android: calls start a few seconds later, and nobody sees where you connect from.",
  'foot.privacy': "Privacy policy",
  'foot.stato': "Service status: what is answering right now",
  'hero.qr': "Scan it with your phone",
  'hero.installa': "How to install it on Android, iPhone and computer — and how to get the most out of it",
...
T.fr = {
  ...
  'hero.apkUpdate': "Vous voulez qu'elle se mette à jour toute seule ? Installez-la avec Obtainium.",
  ...
  'what.1b': "Qui la possède vous joint quand il veut, sans connaître votre numéro de téléphone. Le rappeler ensuite ne prend qu'un geste.",
  ...
  'what.4t': "Envoyez les fichiers tels qu'ils sont vraiment",
  'what.4b': "Photos, vidéos et documents jusqu'à 512 Mo, plusieurs à la fois, en qualité originale — jamais compressés.",
  'what.5t': "Montrez votre écran pendant que vous parlez",
  'what.5b': "Utile pour aider à distance quelqu'un moins à l'aise avec la technologie : il voit votre écran, vous lui dites où toucher.",
  ...
  'foot.formal': "Le protocole écrit en entier et les modèles de vérification formelle (Tamarin, ProVerif) : publics, réexécutables, pas encore relus par un tiers — relecteur recherché",
  'foot.vpn': "Fonctionne aussi avec un VPN, ou avec Tor via Orbot sur Android : les appels démarrent quelques secondes plus tard, et personne ne voit d'où vous vous connectez.",
  'foot.privacy': "Politique de confidentialité",
  'foot.stato': "État du service : ce qui répond en ce moment",
  'hero.qr': "Scannez-le avec votre téléphone",
  'hero.installa': "Comment l'installer sur Android, iPhone et ordinateur — et en tirer le maximum",
...
T.de = {
  ...
  'hero.apkUpdate': "Soll sie sich von selbst aktualisieren? Dann installiere sie mit Obtainium.",
  ...
  'what.1b': "Wer sie hat, erreicht dich jederzeit, ohne deine Telefonnummer zu kennen. Sie danach zurückzurufen ist nur ein Fingertipp.",
  ...
  'what.4t': "Schick Dateien so, wie sie wirklich sind",
  'what.4b': "Fotos, Videos und Dokumente bis zu 512 MB, mehrere auf einmal, in Originalqualität — nie komprimiert.",
  'what.5t': "Zeig deinen Bildschirm, während ihr sprecht",
  'what.5b': "Nützlich, um jemandem, der sich mit Technik weniger auskennt, aus der Ferne zu helfen: er sieht deinen Bildschirm, du sagst ihm, wo er tippen soll.",
  ...
  'foot.formal': "Das vollständig beschriebene Protokoll und die Modelle der formalen Verifikation (Tamarin, ProVerif): öffentlich, nachvollziehbar, noch nicht unabhängig geprüft — Prüfer gesucht",
  'foot.vpn': "Funktioniert auch über ein VPN oder über Tor mit Orbot auf Android: Anrufe starten ein paar Sekunden später, und niemand sieht, von wo du dich verbindest.",
  'foot.privacy': "Datenschutzerklärung",
  'foot.stato': "Dienststatus: was gerade antwortet",
  'hero.qr': "Mit dem Handy scannen",
  'hero.installa': "So installierst du es auf Android, iPhone und Computer — und holst das Maximum heraus",
...
T.es = {
  ...
  'hero.apkUpdate': "¿Quieres que se actualice sola? Instálala con Obtainium.",
  ...
  'what.1b': "Quien la tenga puede localizarte cuando quiera, sin conocer tu número de teléfono. Volver a llamarle después es solo un toque.",
  ...
  'what.4t': "Manda los archivos tal como son",
  'what.4b': "Fotos, vídeos y documentos hasta 512 MB, varios a la vez, en la calidad original — nunca comprimidos.",
  'what.5t': "Muestra tu pantalla mientras habláis",
  'what.5b': "Útil para ayudar a distancia a quien tiene menos soltura con la tecnología: ve tu pantalla, tú le dices dónde tocar.",
  ...
  'foot.formal': "El protocolo escrito por completo y los modelos de verificación formal (Tamarin, ProVerif): públicos, reejecutables, aún sin revisión independiente — se busca revisor",
  'foot.vpn': "Funciona también con una VPN, o con Tor mediante Orbot en Android: las llamadas empiezan unos segundos más tarde, y nadie ve desde dónde te conectas.",
  'foot.privacy': "Política de privacidad",
  'foot.stato': "Estado del servicio: qué responde ahora",
  'hero.qr': "Escanéalo con el teléfono",
  'hero.installa': "Cómo instalarlo en Android, iPhone y ordenador — y cómo sacarle el máximo",
...
T.pt = {
  ...
  'hero.apkUpdate': "Queres que se atualize sozinha? Instala-a com o Obtainium.",
  ...
  'what.1b': "Quem o tiver pode contactá-lo quando quiser, sem saber o seu número de telefone. Voltar a ligar-lhe depois é só um toque.",
  ...
  'what.4t': "Envie os ficheiros tal como são",
  'what.4b': "Fotografias, vídeos e documentos até 512 MB, vários de cada vez, na qualidade original — nunca comprimidos.",
  'what.5t': "Mostre o seu ecrã enquanto falam",
  'what.5b': "Útil para ajudar à distância quem tem menos à-vontade com a tecnologia: vê o seu ecrã, e você diz-lhe onde tocar.",
  ...
  'foot.formal': "O protocolo escrito por inteiro e os modelos de verificação formal (Tamarin, ProVerif): públicos, reexecutáveis, ainda sem revisão independente — procura-se revisor",
  'foot.vpn': "Funciona também com uma VPN, ou com Tor através do Orbot no Android: as chamadas começam alguns segundos mais tarde, e ninguém vê de onde se liga.",
  'foot.privacy': "Política de privacidade",
  'foot.stato': "Estado do serviço: o que responde agora",
  'hero.qr': "Aponte a câmara do telemóvel",
  'hero.installa': "Como instalar no Android, iPhone e computador — e como tirar o máximo",
...
T.ru = {
  ...
  'hero.apkUpdate': "Хотите, чтобы приложение обновлялось само? Установите его через Obtainium.",
  ...
  'what.1b': "Тот, у кого он есть, свяжется с вами когда захочет, не зная вашего номера телефона. Перезвонить ему потом — одно касание.",
  ...
  'what.4t': "Отправляйте файлы такими, какие они есть",
  'what.4b': "Фото, видео и документы до 512 МБ, несколько сразу, в исходном качестве — никогда не сжимаются.",
  'what.5t': "Покажите свой экран во время разговора",
  'what.5b': "Полезно, чтобы помочь на расстоянии тому, кто менее уверенно чувствует себя с техникой: он видит ваш экран, а вы говорите, куда нажать.",
  ...
  'foot.formal': "Полное описание протокола и модели формальной верификации (Tamarin, ProVerif): открытые, воспроизводимые, ещё без независимой проверки — ищем рецензента",
  'foot.vpn': "Работает и через VPN, и через Tor с Orbot на Android: звонки начинаются на несколько секунд позже, и никто не видит, откуда вы подключаетесь.",
  'foot.privacy': "Политика конфиденциальности",
  'foot.stato': "Состояние сервиса: что отвечает сейчас",
  'hero.qr': "Отсканируйте телефоном",
  'hero.installa': "Как установить на Android, iPhone и компьютер — и использовать по максимуму",
...
T.zh = {
  ...
  'foot.formal': "完整写出的协议与形式化验证模型（Tamarin、ProVerif）：公开、可重跑，尚未经第三方审阅——诚征审阅者",
  'foot.vpn': "也可通过 VPN 使用，或在 Android 上通过 Orbot 使用 Tor：通话晚几秒开始，没有人能看到你从哪里连接。",
  'foot.privacy': "隐私政策",
  'foot.stato': "服务状态：现在什么在响应",
  'hero.qr': "用手机扫一扫",
  'hero.installa': "如何在 Android、iPhone 和电脑上安装 — 以及如何用到极致",
  'compare.title': "有何不同",
...
T.ar = {
  ...
  'hero.apkUpdate': "تريد أن يبقى التطبيق محدَّثًا من تلقاء نفسه؟ ثبّته عبر Obtainium.",
  ...
  'what.1b': "من يملكه يصل إليك متى شاء، دون أن يعرف رقم هاتفك. معاودة الاتصال به لاحقًا تحتاج لمسة واحدة فقط.",
  ...
  'what.4t': "أرسل الملفات كما هي حقًا",
  'what.4b': "صور وفيديوهات ومستندات حتى 512 ميجابايت، عدة ملفات دفعة واحدة، بجودتها الأصلية — لا تُضغط أبدًا.",
  'what.5t': "أظهر شاشتك أثناء الحديث",
  'what.5b': "مفيد لمساعدة من هم أقل دراية بالتكنولوجيا عن بُعد: يرون شاشتك، وأنت تخبرهم أين يلمسون.",
  'how.title': "كيف يعمل",
  ...
  'foot.formal': "البروتوكول مكتوب بالكامل ونماذج التحقق الشكلي (Tamarin وProVerif): علنية، قابلة لإعادة التشغيل، لم تُراجَع بعد من طرف مستقل — مطلوب مراجع",
  'foot.vpn': "يعمل أيضًا عبر VPN، أو عبر Tor بواسطة Orbot على أندرويد: تبدأ المكالمات بعد ثوانٍ، ولا أحد يرى من أين تتصل.",
  'foot.privacy': "سياسة الخصوصية",
  'foot.stato': "حالة الخدمة: ما الذي يستجيب الآن",
  'hero.qr': "امسحه بكاميرا هاتفك",
  'hero.installa': "كيف تثبّته على أندرويد وآيفون والكمبيوتر — وكيف تستفيد منه إلى أقصى حد",
...
T.ur = {
  ...
  'hero.apkUpdate': "چاہتے ہیں کہ یہ خود بخود اپ ڈیٹ ہوتا رہے؟ اسے Obtainium کے ذریعے انسٹال کریں۔",
  ...
  'what.1b': "جس کے پاس یہ ہو وہ جب چاہے آپ تک پہنچ سکتا ہے، آپ کا فون نمبر جانے بغیر۔ بعد میں اسے دوبارہ کال کرنا صرف ایک ٹچ ہے۔",
  ...
  'what.4t': "فائلیں جیسی وہ واقعی ہیں بھیجیں",
  'what.4b': "512 ایم بی تک تصاویر، ویڈیوز اور دستاویزات، ایک ساتھ کئی، اصل کوالٹی میں — کبھی کمپریس نہیں کی جاتیں۔",
  'what.5t': "بات کرتے ہوئے اپنی اسکرین دکھائیں",
  'what.5b': "ٹیکنالوجی سے کم واقف لوگوں کی دور سے مدد کے لیے مفید: وہ آپ کی اسکرین دیکھتے ہیں، آپ بتاتے ہیں کہاں ٹچ کریں۔",
  ...
  'foot.formal': "مکمل لکھا ہوا پروٹوکول اور رسمی تصدیق کے ماڈل (Tamarin، ProVerif): عوامی، دوبارہ چلانے کے قابل، ابھی آزادانہ جائزہ نہیں ہوا — جائزہ کار درکار",
  'foot.vpn': "VPN کے ساتھ، یا اینڈرائیڈ پر Orbot کے ذریعے Tor کے ساتھ بھی چلتا ہے: کالیں چند سیکنڈ دیر سے شروع ہوتی ہیں، اور کوئی نہیں دیکھتا آپ کہاں سے جڑ رہے ہیں۔",
  'foot.privacy': "پرائیویسی پالیسی",
  'foot.stato': "سروس کی حالت: اس وقت کیا جواب دے رہا ہے",
  'hero.qr': "اپنے فون سے اسکین کریں",
  'hero.installa': "اینڈرائیڈ، آئی فون اور کمپیوٹر پر انسٹال کیسے کریں — اور زیادہ سے زیادہ فائدہ کیسے اٹھائیں",
...
T.hi = {
  ...
  'hero.apkUpdate': "चाहते हैं कि यह अपने आप अपडेट होता रहे? इसे Obtainium से इंस्टॉल करें।",
  ...
  'what.1b': "जिसके पास यह हो वह जब चाहे आप तक पहुँच सकता है, आपका फ़ोन नंबर जाने बिना। बाद में उसे फिर से कॉल करना बस एक टैप है।",
  ...
  'what.4t': "फ़ाइलें जैसी वे असल में हैं वैसे भेजें",
  'what.4b': "512 एमबी तक की फ़ोटो, वीडियो और दस्तावेज़, एक साथ कई, असली क्वालिटी में — कभी कंप्रेस नहीं होते।",
  'what.5t': "बात करते हुए अपनी स्क्रीन दिखाएं",
  'what.5b': "तकनीक से कम परिचित किसी की दूर से मदद करने के लिए उपयोगी: वे आपकी स्क्रीन देखते हैं, आप बताते हैं कहाँ छूना है।",
  ...
  'foot.formal': "पूरा लिखा हुआ प्रोटोकॉल और औपचारिक सत्यापन मॉडल (Tamarin, ProVerif): सार्वजनिक, दोबारा चलाने योग्य, अभी स्वतंत्र समीक्षा नहीं हुई — समीक्षक चाहिए",
  'foot.vpn': "VPN के साथ भी चलता है, या Android पर Orbot के ज़रिये Tor के साथ: कॉल कुछ सेकंड देर से शुरू होती हैं, और कोई नहीं देखता आप कहाँ से जुड़ रहे हैं।",
  'foot.privacy': "गोपनीयता नीति",
  'foot.stato': "सेवा की स्थिति: अभी क्या जवाब दे रहा है",
  'hero.qr': "अपने फ़ोन से स्कैन करें",
  'hero.installa': "Android, iPhone और कंप्यूटर पर इसे कैसे इंस्टॉल करें — और इसका पूरा फ़ायदा कैसे लें",
...
T.bn = {
  ...
  'hero.apkUpdate': "চান এটি নিজে থেকেই হালনাগাদ থাকুক? Obtainium দিয়ে ইনস্টল করুন।",
  ...
  'what.1b': "যার কাছে এটি আছে সে যখন খুশি আপনার সঙ্গে যোগাযোগ করতে পারে, আপনার ফোন নম্বর না জেনেই। পরে তাকে আবার কল করা শুধু একটি ট্যাপ।",
  ...
  'what.4t': "ফাইল যেমন সত্যিই আছে তেমনই পাঠান",
  'what.4b': "৫১২ এমবি পর্যন্ত ছবি, ভিডিও ও নথি, একসঙ্গে একাধিক, আসল মানে — কখনও সংকুচিত হয় না।",
  'what.5t': "কথা বলার সময় আপনার স্ক্রিন দেখান",
  'what.5b': "প্রযুক্তিতে কম স্বচ্ছন্দ কাউকে দূর থেকে সাহায্য করতে দরকারী: তিনি আপনার স্ক্রিন দেখেন, আপনি বলেন কোথায় চাপতে হবে।",
  ...
  'foot.formal': "সম্পূর্ণ লেখা প্রোটোকল ও আনুষ্ঠানিক যাচাইয়ের মডেল (Tamarin, ProVerif): প্রকাশ্য, পুনরায় চালানো যায়, এখনও স্বাধীন পর্যালোচনা হয়নি — পর্যালোচক চাই",
  'foot.vpn': "VPN দিয়েও চলে, বা Android-এ Orbot-এর মাধ্যমে Tor দিয়ে: কল কয়েক সেকেন্ড দেরিতে শুরু হয়, আর কেউ দেখে না আপনি কোথা থেকে সংযুক্ত হচ্ছেন।",
  'foot.privacy': "গোপনীয়তা নীতি",
  'foot.stato': "সেবার অবস্থা: এখন কী সাড়া দিচ্ছে",
  'hero.qr': "আপনার ফোন দিয়ে স্ক্যান করুন",
  'hero.installa': "Android, iPhone ও কম্পিউটারে কীভাবে ইনস্টল করবেন — এবং সর্বোচ্চ সুবিধা কীভাবে নেবেন",
...
T.id = {
  ...
  'hero.apkUpdate': "Ingin aplikasinya memperbarui dirinya sendiri? Pasang lewat Obtainium.",
  ...
  'what.1b': "Siapa pun yang memilikinya bisa menghubungi Anda kapan saja, tanpa tahu nomor telepon Anda. Meneleponnya lagi setelah itu hanya satu ketukan.",
  ...
  'what.4t': "Kirim berkas apa adanya",
  'what.4b': "Foto, video, dan dokumen hingga 512 MB, beberapa sekaligus, dalam kualitas asli — tidak pernah dikompresi.",
  'what.5t': "Tunjukkan layar Anda saat berbicara",
  'what.5b': "Berguna untuk membantu dari jauh orang yang kurang terbiasa dengan teknologi: mereka melihat layar Anda, Anda memberi tahu di mana harus menyentuh.",
  ...
  'foot.formal': "Protokol yang ditulis lengkap dan model verifikasi formal (Tamarin, ProVerif): publik, dapat dijalankan ulang, belum ditinjau pihak independen — dicari peninjau",
  'foot.vpn': "Juga berfungsi lewat VPN, atau lewat Tor via Orbot di Android: panggilan mulai beberapa detik lebih lambat, dan tidak ada yang melihat dari mana kamu terhubung.",
  'foot.privacy': "Kebijakan privasi",
  'foot.stato': "Status layanan: apa yang merespons sekarang",
  'hero.qr': "Pindai dengan ponsel Anda",
  'hero.installa': "Cara memasangnya di Android, iPhone, dan komputer — dan cara memakainya secara maksimal",
