...
Node 22. Node finds the files itself. 516 tests, 81 suites, about three
minutes, and it exits on its own (measured: 207 s, 18 Sep 2026). They also run on every push. (That count is measured, and goes stale —
